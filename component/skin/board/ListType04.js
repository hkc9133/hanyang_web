...
const ListType04 = ({content,board,loading,moveContentDetail,pageChange}) => {
                        ...
                        {content.list.map((item) =>{
                            return (
                                <tr key={item.contentId}>
                                    ...
                                    <td className={cx("txt_l")}><Link href={item.sub01}><a target="_blank">{item.title}</a></Link></td>
...
export default React.memo(ListType04);
