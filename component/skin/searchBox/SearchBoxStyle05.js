...
const SearchBoxStyle05 = ({searchContent,changeSearchInfo,category,searchInfo}) => {
    ...
    return (
        <fieldset className={cx("search_wrap","search_05")}>
...
export default React.memo(SearchBoxStyle05);
