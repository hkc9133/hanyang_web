                ...
                <li className={cx("answer", {show: showAnswer == item.formId, hidden: showAnswer != item.formId})}>
                    ...
                    {counselApply.counselApply.applyStatus == "COMPLETED" && counselApply.counselApply.score == null ? (
                        ...
                        <div className={cx("review")}>
                            <Rate allowHalf defaultValue={updateScore} value={updateScore} onChange={setUpdateScore}/>
                        </div>
                        <button type="button" className={cx("btn_save")} onClick={() =>{handleUpdateScore(counselApply.counselApply.formId,updateScore)}}>저장</button>
                        </div>
                    ) : (
