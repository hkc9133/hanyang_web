...
import {getBoardSearchListEn} from "../../store/main/main";
...
const SearchPage = ({info}) => {
    ...
    useEffect(() => {
        ...
        dispatch(getBoardSearchListEn(info))
    ...
    useEffect(() => {
        ...
        dispatch(getBoardSearchListEn(data));
        // }
    ...
    return (
        <section className={cx("sub_container","online_content")}>
            <h1 className={cx("sub_top_title")}>Search results</h1>
            <p className={cx("sub_top_txt")}>Check your search results. </p>
