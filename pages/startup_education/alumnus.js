    ...
    return (
        ...
        <section className={cx("container", "alumnus")}>
            <div className={cx("sub_cont", "sub_cont_top")}>
                <h1 className={cx("sub_top_title")}>동문대상 창업교육​</h1>
                <p className={cx("sub_top_txt")}>한양동문 및 일반 예비창업자를 적극적으로 발굴, 육성 사업화 과정을 지원</p>
            </div>
                    ...
                    <div className={cx("txt_style_1")}>
                        ...
                        <div className={cx("txtArea")}>
                            <p className={cx("txt_1")}>
                                한양대학교가 운영하는 CEO 양성 프로젝트 핵심 프로그램으로 한양동문 및 일반 예비창업자를 적극적으로 발굴 , 육성하여 성공적인 창업과 사업화 과정을
                                지원합니다​
                            </p>
                            <div className={cx("list_style_1")}>
                                <ul>
                                    <li>
                                        ...
                                        한양대학교· 한양여자대학교 · 한양사이버대학교 재 휴 학생 , 졸업 동문 등 예비 초기 창업자 대상​
                                        ※ 한양대 재학생에 한해 수료 시 3 학점 절대평가 인정
                                    </li>
                                    <li>
            ...
            <div className={cx("sub_cont", "alumnusCont_1")}>
                <div className={cx("txt_style_1")}>
                    <div className={cx("left_title")}>
                        <h1 className={cx("title_style_2")}>과정일정과 주제</h1>
                    </div>
                    <div className={cx("txtArea")}>
                        <ul>
                            <li>
                                <span className={cx("title")}>기본과정 (1~7 주차)</span>
                                <ul>
                            ...
                            <li>
                                <span className={cx("title")}>실전마케팅 과정 (8~9 주차)</span>
                                <ul>
                                    <li>- 마케팅 판로개척 강의</li>
                            ...
                            <li>
                                <span className={cx("title")}>투자유치과정 (10~15 주차)</span>
                                <ul>
                                    <li>- 정부 정책자금 조달 및 활용법</li>
                                    <li>- 자금조달과 투자유치 , 데모데이, 네트워킹데이</li>
                ...
                <div className={cx("txt_style_1")}>
                    ...
                    <div className={cx("txtArea")}>
                        <ul>
                            ...
                            <li>- 특허 , 법률 , 회계 , 마케팅 , 판로개척 등 멘토링 상시 제공</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div className={cx("tb_style_1")}>
                            <table>
                                ...
                                <tr>
                                    <td>창업에대한 지식과 이해력</td>
                                    <td>20점</td>
                                    <td>유사직종 재직 경험, 전문적인 지식, 네트워크 보유 등</td>
                                </tr>
                                <tr>
                                    <td>사업화 계획의 적정성 및 실현 가능성</td>
                                    <td>40점</td>
                                    <td>추진계획의구체성, 사업화 실현가능성, 개혁지향적인 의지와 추진 능력 등</td>
                                </tr>
                                <tr>
                                    <td>창업 아이템의 우수성</td>
                                    <td>40점</td>
            ...
            <div className={cx("sub_cont", "alumnusCont_4")}>
                <div className={cx("txt_style_1")}>
                    <div className={cx("left_title")}>
                        <h1 className={cx("title_style_2")}>면접평가기준</h1>
                    </div>
                    <div className={cx("txtArea")}>
                        <div className={cx("tb_style_1")}>
                            <table>
            ...
            <div className={cx("sub_cont", "alumnusCont_5")}>
                <div className={cx("txt_style_1")}>
                    <div className={cx("left_title")}>
                        <h1 className={cx("title_style_2")}>활동모습</h1>
                    </div>
                    <div className={cx("txtArea")}>
                        <ul>
                            <li>
            ...
            <div className={cx("sub_cont", "alumnusCont_6")}>
                <div className={cx("txt_style_1")}>
                    <div className={cx("left_title")}>
                        <h1 className={cx("title_style_2")}>아카데미 History <br/>&amp;원우회</h1>
                    </div>
                    <div className={cx("txtArea")}>
