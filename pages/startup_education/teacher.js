        ...
        <>
            ...
            <section className={cx("container","teacherCont")}>
                <div className={cx("sub_cont","sub_cont_top")}>
                    <h1 className={cx("sub_top_title")}>교원대상</h1>
                    ...
                    <div className={cx("sub_cont")}>
                        <div className={cx("txt_style_1")}>
                            <div className={cx("left_title")}>
                                <h1 className={cx("title_style_2")}>교원창업포럼</h1>
                            </div>
                                ...
                                <div className={cx("list_style_1")}>
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>본교 교원의 기술창업 활성화를 위한 현직 대학교수 및 연구원, 창업전문가, 교원창업 성공기업 CEO들 의 정보 공유 및
                                                    소통의 장 마련​
                                                </li>
                                                <li>교원창업 유경험자로부터 성공 창업 스토리를 공유하고 , 실험실창업팀의 창업기술과제 발표와 각 기술 분야별 전문가와의 심사와
                                                    멘토링을 통해 사업화 단계별 맞춤형 문제해결 방안을 모색하는 등 교원의 창업 분위기 확산의 장 마련
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                ...
                <div className={cx("sub_cont")}>
                    <div className={cx("txt_style_1")}>
                        ...
                        <div className={cx("txtArea")}>
                            <p className={cx("txt_1")}>한양대학교소속 실험실을 대상으로 하는 집체 실습 교육 프로그램으로 기술사업화 로드맵에 근거한 타겟 기술의 사업화 타당성을 검증과
                                실제 시장 내 고객의 탐색 (Customer 과정을 진행합니다.</p>
                            <div className={cx("list_style_1")}>
                                <ul>
                                    <li>
                                        <span className={cx("title")}>모집대상 </span>
                ...
                <div className={cx("gray_bg")}>
                    <div className={cx("sub_cont")}>
                        <div className={cx("txt_style_1")}>
                            ...
                            <div className={cx("txtArea")}>
                                <p className={cx("txt_1")}>한양대학교 소속 실험실을 대상으로 하는 Lab 2 Market 아이템 검증 및 고객 탐색 프로그램의 결과를 바탕으로 최종
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>실험실별로 기술자체분석 보고서를 기반으로 기술사업화 로드맵 방법론을 근거하여 해당 기술의 사업화 타당성을 검증하고
                                                    해당기술이 실제 창업을 통해시장에서 적합하게 사업화 되어질 수 있는가에 대한 타당성 검증을 위한 고객 탐색
                                                    (Customer 과정을 수행해보고 최종 성과 실험실 기술사업화를 발표함으 로써 실험실별 창업역량을 강화​
                                                </li>
                                                <li>참여 실험실 특화형 창업선도대학 사업 참여 지원기술 팀들의 사업화 성과공유 및 사후 지원 , 후속 투자 유치 방안 모색 등
                                                    논의​
                                                </li>
                                            </ul>
                                        </li>
