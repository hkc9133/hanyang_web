    ...
    return (
        <section className={cx("container")}>
            <div className={cx("sub_container","calendar")}>
                ...
                {searchInfo.type == "C" && (
                    <BoardSkinSelector skinName={'Calendar01'} events={notice.list} cateList={notice.cate} changeCategory={changeCategory} changeType={changeType}/>

                )}
                {searchInfo.type == "L" &&(
                    <BoardSkinSelector skinName={'EventListType01'} list={notice.list} cateList={notice.cate} page={notice.page} pageChange={pageChange} changeCategory={changeCategory} changeType={changeType}/>
                )}
