...
import {getCounselApply, getMentorCounselApplyList} from "../../../store/mentoring/mentoring";
        ...
        <div>
            <section className={cx("container")}>
                <div className={cx("sub_container","mentor_groupList")}>
                    ...
                    <MentorCounselApplyHistory counselApplyList={counselApplyList} handleShowAnswer={handleShowAnswer} showAnswer={showAnswer} cx={cx} pageChange={pageChange}/>
                </div>
            </section>
        </div>
    );
