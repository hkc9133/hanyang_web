            ...
            <section className={cx("sub_container","newsletter_content")}>
                ...
                <div className={cx("news_board_wrap")}>
                    ...
                    <div className={cx("news_board_cont")}>
                        <img src="/assets/image/newsletter_temp_sub/04/1.png" alt="1"/>
                        <img src="/assets/image/newsletter_temp_sub/04/2.jpg" alt="2"/>
                        <img src="/assets/image/newsletter_temp_sub/04/3.jpg" alt="3"/>
                        <img src="/assets/image/newsletter_temp_sub/04/4.jpg" alt="4"/>
                        <img src="/assets/image/newsletter_temp_sub/04/5.jpg" alt="5"/>
                    </div>
