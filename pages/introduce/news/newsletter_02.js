            ...
            <section className={cx("sub_container","newsletter_content")}>
                ...
                <div className={cx("news_board_wrap")}>
                    ...
                    <div className={cx("news_board_cont")}>
                        <img src="/assets/image/newsletter_temp_sub/02/1.png" alt="1"/>
                        <img src="/assets/image/newsletter_temp_sub/02/2.jpg" alt="2"/>
                        <img src="/assets/image/newsletter_temp_sub/02/3.jpg" alt="3"/>
                        <img src="/assets/image/newsletter_temp_sub/02/4.jpg" alt="4"/>
                        <img src="/assets/image/newsletter_temp_sub/02/5.jpg" alt="5"/>
                        <img src="/assets/image/newsletter_temp_sub/02/6.jpg" alt="6"/>
                    </div>
