            ...
            <section className={cx("sub_container","newsletter_content")}>
                ...
                <div className={cx("news_board_wrap")}>
                    ...
                    <div className={cx("news_board_cont")}>
                        <img src="/6assets/image/newsletter_temp_sub/06/1.png" alt="1"/>
                        <img src="/assets/image/newsletter_temp_sub/06/2.jpg" alt="2"/>
                        <img src="/assets/image/newsletter_temp_sub/06/3.jpg" alt="3"/>
                        <img src="/assets/image/newsletter_temp_sub/06/4.jpg" alt="4"/>
                        <img src="/assets/image/newsletter_temp_sub/06/5.jpg" alt="5"/>
                        <img src="/assets/image/newsletter_temp_sub/06/6.jpg" alt="6"/>
                        <img src="/assets/image/newsletter_temp_sub/06/7.jpg" alt="7"/>
                        <img src="/assets/image/newsletter_temp_sub/06/8.jpg" alt="8"/>
                    </div>
