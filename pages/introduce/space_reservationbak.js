...
const SpaceReservation = () => {
    ...
    const {spaceInfo, addSchedule, spaceInfoLoading, addScheduleLoading} = useSelector(({
                                                                                            spaceRental,
                                                                                            loading
                                                                                        }) => ({
                ...
                <div className={`${cx("sub_container")} sssup `}>
                    ...
                    <div className={`${cx("tab_style_2")} mb_30`}>
                        <ul>
                            ...
                            <li><Link href="/introduce/space_reservation/manage"><a><span> 확인/ 취소하기</span></a></Link></li>
                        </ul>
                    </div>
                    {step == 1 && (
                        <>
